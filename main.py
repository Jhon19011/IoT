...
fig, ax = plt.subplot()
ax.plot(["Categoría"],df["Valores"],marker="o", linestyle="-",color="b")
...
fig_bar = px.bar(df, x="Categoría", y ="Valores",text="Valores", color = "Categoria",title="")
